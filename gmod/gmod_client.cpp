void CC_GM_ShowHelp ( const CCommand &args )
{
	CBasePlayer* ply = UTIL_GetCommandClient();

	gGM.CallWithArgs(1); // ToDo: Verify the argument
...
ConCommand gm_showhelp( "gm_showhelp", CC_GM_ShowHelp , "", 0);

void CC_GM_ShowTeam ( const CCommand &args )
{
	CBasePlayer* ply = UTIL_GetCommandClient();
...
ConCommand gm_showteam( "gm_showteam", CC_GM_ShowTeam , "", 0);

void CC_GM_ShowSpare1 ( const CCommand &args )
{
	CBasePlayer* ply = UTIL_GetCommandClient();
...
ConCommand gm_showspare1( "gm_showspare1", CC_GM_ShowSpare1 , "", 0);

void CC_GM_ShowSpare2 ( const CCommand &args )
{
	CBasePlayer* ply = UTIL_GetCommandClient();
...
ConCommand gm_showspare2( "gm_showspare2", CC_GM_ShowSpare2 , "", 0);

// ToDO: Verify if everything below belongs here.
...
//-----------------------------------------------------------------------------
void ClientGamePrecache( void ) // Gmod ToDo: Verify if this is right.
{
